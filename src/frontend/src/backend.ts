...
export class Backend implements backendInterface {
    ...
    async addReading(arg0: number, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addReading(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async fetchWaterLevel(arg0: string): Promise<number> {
        if (this.processError) {
            try {
                const result = await this.actor.fetchWaterLevel(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getReadings(): Promise<Array<Reading>> {
        if (this.processError) {
            try {
                const result = await this.actor.getReadings();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
